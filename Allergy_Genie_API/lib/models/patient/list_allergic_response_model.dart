...
class ListAllergicResponseModel extends BaseAPIResponse<List<Allergic>, Null> {
  ListAllergicResponseModel(fullJson) : super(fullJson);

  @override
  dataToJson(List<Allergic>? data) {
    if (this.data != null) {
  ...
  @override
  List<Allergic>? jsonToData(Map<String, dynamic>? json) {
    if (json != null) {
      data = [];

      json["data"].forEach((v) {
        data!.add(Allergic.fromJson(v));
      });
