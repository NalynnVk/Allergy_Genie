...
class ListInsightResponseModel extends BaseAPIResponse<List<Insight>, Null> {
  ListInsightResponseModel(fullJson) : super(fullJson);

  @override
  dataToJson(List<Insight>? data) {
    if (this.data != null) {
  ...
  @override
  List<Insight>? jsonToData(Map<String, dynamic>? json) {
    if (json != null) {
      data = [];

      json["data"].forEach((v) {
        data!.add(Insight.fromJson(v));
      });
